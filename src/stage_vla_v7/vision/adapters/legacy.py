"""Duck-typed adapter for existing V5 compact or YOLO detectors."""

from __future__ import annotations

from typing import Mapping

from stage_vla_v7.contracts import ModelDescriptor, ObjectDetection, ProviderError, SceneState
...
class LegacyDetectorAdapter:
    ...
    The detector object is created by the application. This package therefore
    never imports V5, OpenCV, Ultralytics, NumPy, or Torch.
    """
